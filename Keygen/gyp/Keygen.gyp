...

{
  ...
  'targets': [{
    ...
    'variables': {
      ...
      'build_defines%': '',
      'list_sources_command': 'python <(submodules_loc)/lib_base/gyp/list_sources.py --input <(DEPTH)/keygen/sources.txt --replace src_loc=<(src_loc)',
